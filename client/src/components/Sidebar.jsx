...
export default memo(function Sidebar({ sidebarOpen, setSidebarOpen }) {
	...
	return (
		<>
			...
			<div className={`fixed z-30 inset-y-0 left-0 w-60 transition duration-300 transform bg-indigo-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'}`}>
