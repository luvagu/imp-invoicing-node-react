export default function SearchResultsInPage({ results }) {
    return (
            ...
            <table className="w-full leading-normal">
                <thead>
                    <tr className="bg-gray-100">
                        ...
                        <th
                            className="px-5 py-3 border-b-2 border-gray-200 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider hidden lg:table-cell">
                            Stock
                        </th>
                        <th
                            className="px-5 py-3 border-b-2 border-gray-200 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider hidden lg:table-cell">
                ...
                {results.map((res, idx) => (
                    <tr key={idx} className="bg-white hover:bg-gray-50">
                        <td className="px-5 py-5 border-b border-gray-200 text-sm">
                            <p className="text-gray-900 whitespace-no-wrap">{res.code}</p>
                        </td>
                        <td className="px-5 py-5 border-b border-gray-200 text-sm">
